...
def test_build_base_rate_table_sub_war_filter(cow_db):
    ...
    table = build_base_rate_table(scenario, cow_client=CoWDataClient(sqlite_path=cow_db))
...
def test_build_base_rate_table_unavailable(tmp_path):
    ...
    table = build_base_rate_table(scenario, cow_client=CoWDataClient(sqlite_path=tmp_path / "missing.db"))
